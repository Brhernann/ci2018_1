...
export const buttom_with_function = (back, next) => {
  return (
    ...
    >
      <Button.Group size="large">
        <Tooltip placement="bottomRight" title={"Volver"}>
          <Button type="primary" style={{ marginRight: 5 }} onClick={back}>
            <Icon type="left" />
          </Button>
        </Tooltip>

        <Tooltip placement="bottomLeft" title={"Siguiente"}>
          <Button type="primary" style={{ marginLeft: 5 }} onClick={next}>
            <Icon type="right" />
          </Button>
        </Tooltip>
      </Button.Group>
...
export const token_valid = () => {
  return (
    <Card
      title="Bienvenido a Corporate Index"
      bordered={false}
      style={cardstyle}
    >
      <div>
...
export const token_valid_person = () => {
  return (
    <Card
      title="Bienvenido a Corporate Index"
      bordered={false}
  ...
  return (
    <Card title="Bienvenido usuario" bordered={false} style={cardstyle}>
      <div>
        ...
        <div>
          <p>
            Gracias por <strong style={{ color: "#1088e9" }}> dedicar </strong>{" "}
