...
import { AutoCompany } from "../../../../actions/Register";
...
class GETFactorAE extends Component {
...
const WrappedNormalLoginForm = Form.create()(GETFactorAE);

const mapStateToProps = state => {
    return {CollapseReducers: state.CollapseReducers, companyReducers: state.companyReducers,getRegisterAutoEvaluation: state.registerReducers.getRegisterAutoEvaluation
    }
}
