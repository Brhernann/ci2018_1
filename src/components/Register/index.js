...
class Register extends Component {
  ...
  GetCommune(value) {
    let Communes = REGION.regiones.filter(q => q.region === value);
          ...
          <FormContent>
            ...
            <FirstChild>
              <Item
                ...
                validateStatus={label_3_Error ? "error" : ""}
                help={label_3_Error || ""}
              >
            ...
            <FirstChild>
              <Item
                ...
                validateStatus={label_6_Error ? "error" : ""}
                help={label_6_Error || ""}
              >
            ...
            <FirstChild>
              <Item
                ...
                validateStatus={label_7_Error ? "error" : ""}
                help={label_7_Error || ""}
              >
                {getFieldDecorator("label_7", {
                  ...
                  <Select
                    placeholder="Ejemplo"
                    onChange={this.GetCommune.bind(this)}
                  >
                    {REGION.regiones.map((q, i) => (
                      <Option key={i} value={q.region}>
                        {q.region}
                      </Option>
                    ))}
                  </Select>
            ...
            <FirstChild>
              <Item
                ...
                validateStatus={label_8_Error ? "error" : ""}
                help={label_8_Error || ""}
              >
            ...
            <FirstChild>
              <Item
                ...
                validateStatus={label_9_Error ? "error" : ""}
                help={label_9_Error || ""}
              >
                {getFieldDecorator("label_9", {
                  ...
                  <Select placeholder="Ejemplo">
                    <Option value="little">
                      Empresa pequeña (11 y 30 Colaboradores)
                    </Option>
                    <Option value="medium">
                      Empresa mediana (Hasta 100 Colaboradores)
                    </Option>
                    <Option value="large">
                      Emprega grande (Desde 100 y más Colaboradores){" "}
                    </Option>
                  </Select>
                )}
              </Item>
            ...
            <FirstChild>
              <p>
                Inscríbase como uno de nuestros expertos para participar en la
                segunda fase de la investigación y sea parte del selecto grupo
                que evaluará a las empresas en torno a sus niveles de empatía
              </p>
